...
export const OUTFITS_SEED: CreateOutfitDto[] = [
    ...
    {
        imageUrl: 'https://res.cloudinary.com/dhodvztdx/image/upload/v1733036078/freres_new/outfit_2_g9rdj0.webp',
        products: ['Buzo Verde', 'Buzo Verde', 'Buzo Verde']
    },
    {
        imageUrl: 'https://res.cloudinary.com/dhodvztdx/image/upload/v1733036079/freres_new/outfit_3_cudinx.webp',
        products: ['Buzo Verde', 'Buzo Verde', 'Buzo Verde']
    },
]
